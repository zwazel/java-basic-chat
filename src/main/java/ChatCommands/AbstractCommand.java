...
public abstract class AbstractCommand {
  ...
  protected String youNeedOp =
      "You need to have OP rights to use this command!";
  protected String needTargetId =
      "Pls tell me who is the target of this command (ID of the client)";
  protected String thisUserDoesNotExist =
      "This user does not exist! use the command \"/lc\" to see the connected users!";
  ...
  public abstract void printDescription(); // If using this command with "help"
                                           // as an argument, call this method
}
